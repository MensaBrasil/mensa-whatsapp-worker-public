 ...
 * @returns {Promise<{type: string, request_id: number, registration_id: string, group_id: string}|null>} The parsed JSON object from the queue, or null if queue is empty
